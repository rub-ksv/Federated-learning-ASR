...
import numpy as np
'''
   basically copy+paste from espnet file, only change: args.snaps needed
   this is used to tell the script if its working on a snapshot or an already averaged file
'''

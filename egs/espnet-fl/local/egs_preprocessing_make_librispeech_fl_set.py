...
def splitdataset(sourcedir, savedir, stage):
    '''
    Args:
        sourcedir: data file, which is generated by kaldi (espnet)
        savedir: where save the split dataset
        stage: the script should always run from stage 0

    Returns: save the splited dataset in savedir
...
splitdataset(sys.argv[1],sys.argv[2],sys.argv[3])